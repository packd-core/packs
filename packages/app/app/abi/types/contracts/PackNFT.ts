...
export interface PackNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface PackNFT extends BaseContract {
  connect(runner?: ContractRunner | null): PackNFT;
  waitForDeployment(): Promise<this>;

  interface: PackNFTInterface;
